...
import "tachyons";
ReactDOM.render(<MyComponent greeting={"hello " + "newNinja"}/>, document.getElementById('root'));//what react does , use function render , want to render app to document (root)
